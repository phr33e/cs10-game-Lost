...
class MediterraneanJourney(arcade.Window):
    def __init__(self):
        ...
        # Update the global variables to exactly match the user's specific monitor
        ...
        # Force the camera viewport to map perfectly to the new screen dimensions
    ...
    def on_draw(self):
        ...
        # --- 1. MAIN MENU SCREEN ---
        if self.state == "MENU":
            # Using HEIGHT / 2 ensures perfectly centered text on any monitor (16:9, 16:10, ultrawide, etc)
    ...
    def on_update(self, delta_time):
        ...
        if self.spawn_timer >= SPAWN_RATE and not self.stuck_on_rock:
            ...
            if in_zone_3 or in_zone_4 or in_zone_5 or in_zone_6 or self.cg_test_mode or self.current_test_mode:
                ...
                if self.current_test_mode: current_spawn_chance = 0.90
